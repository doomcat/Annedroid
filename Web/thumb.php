...
$site_config['absolute_uri']='';
$site_config['path_thumbnail']='/cache/images/';	//where to cache thumbnails on the server, relative to the DOCUMENT_ROOT
$image_error='/error.gif';	// used if no image could be found, or a gif image is specified
